...
def register_all_tools(server: MCPServer[object], application: MusicApplication) -> None:
...
def register_all_resources(server: MCPServer[object], application: MusicApplication) -> None:
